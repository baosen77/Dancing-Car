...
#               print(self.pilot_state)
    ...
    class MyPilot:
        ...
        def run_threaded(self):
            print("run_threaded:  "+str(self.angle)+"   "+str(self.throttle) )
            return self.angle, self.throttle

        def update(self):
     
              while Building_connection==b"request":
                  a=connection.recv(512)
                  a=str(a,'utf-8')
                  a=a.split("d") 
#                  print("a: "+str(a))
                  x = 0
                  while( x < len(a)):     
                    ...
                    if a[x] == b"exit":
                       ...
                       connection.close()
                       break                                     
                    elif a[x] !=b"request"and a[x]:
                      b=float(a[x])
                      if b >= 2:
                        self.throttle=b-3
                        #print(str(tag)+"  !!!throttle:  "+str(self.throttle))                
                        tag = 1
                        self.run_threaded()                        
                      elif b <= 1: 
                        self.angle=b
                        #print(str(tag)+" !!!angle:   "+str(self.angle))                                     
...
if __name__ == '__main__':
    ...
    while True:  
              ...
              Building_connection = connection.recv(512)
